...
export const CommentList = Translate(({ translate, ...props }) => (
    <List title={translate('comment.all')} {...props} perPage={6} filter={<CommentFilter />} pagination={<CommentPagination />}>
        <CommentGrid />
    </List>
));
...
export const CommentEdit = Translate(({ translate, ...props }) => (
    <Edit {...props}>
        <SimpleForm>
            ...
            <TextInput label={translate('comment.form.author_name')} source="author.name" />
